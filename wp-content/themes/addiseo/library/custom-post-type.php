...
// let's create the function for the custom type participant
function custom_post_atelier() { 
	// creating (registering) the custom type 
	register_post_type( 'atelier', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
		// let's now add all the options for this post type
		array( 'labels' => array(
			'name' => __( 'Ateliers', 'bonestheme' ), /* This is the Title of the Group */
			'singular_name' => __( 'Atelier', 'bonestheme' ), /* This is the individual type */
			'all_items' => __( 'Tous les ateliers', 'bonestheme' ), /* the all items menu item */
			'add_new' => __( 'Add New', 'bonestheme' ), /* The add new menu item */
			'add_new_item' => __( 'Ajouter un nouveau atelier', 'bonestheme' ), /* Add New Display Title */
			'edit' => __( 'Edit', 'bonestheme' ), /* Edit Dialog */
			'edit_item' => __( 'Modifier', 'bonestheme' ), /* Edit Display Title */
			'new_item' => __( 'Nouveau atelier', 'bonestheme' ), /* New Display Title */
			...
			'rewrite'	=> array( 'slug' => 'atelier', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'custom_type', /* you can rename the slug here */
			'capability_type' => 'post',
			'hierarchical' => false,
			/* the next one is important, it tells what's enabled in the post editor */
	...
	add_action( 'init', 'custom_post_atelier');
